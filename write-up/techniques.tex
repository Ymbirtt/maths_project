...
Thge process was simulated for 100 hours, producing a trace such as the one displayed in Figure \ref{trace_nonhom1}.
...
\begin{figure}[h]
\includegraphics[width = \textwidth]{./images/fit_nonhom2.png}
...
\begin{figure}[h]
\includegraphics[width = \textwidth]{./images/raw_data_zoomed.png}
...
\begin{figure}[h!]
\includegraphics[width = \textwidth]{./images/density_mmpp1_state1.png}
...
\begin{figure}[h!]
\includegraphics[width = \textwidth]{./images/density_mmpp1_state2.png}
...
\begin{figure}[h!]
\includegraphics[width = \textwidth]{./images/density_mmpp1_state3.png}
\caption{And so on}
\label{density_mmpp1_state3}
\end{figure}

\begin{figure}[h!]
\includegraphics[width = \textwidth]{./images/density_mmpp1_state4.png}
\caption{And so forth}
\label{density_mmpp1_state4}
\end{figure}

\begin{figure}[h!]
\includegraphics[width = \textwidth]{./images/density_mmpp1_state5.png}
\caption{Up to state 5}
\label{density_mmpp1_state5}
\end{figure}

\begin{figure}[h!]
\includegraphics[width = \textwidth]{./images/density_mmpp2_state3.png}
